        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 ml-auto">
                    <p class="lead">Olá, meu nome é Daslan Mateus, gosto de tecnologias e de está atualizado, sou
                        cristão e amo programação.</p>
                </div>
                <div class="col-lg-4 mr-auto">
                    <p class="lead">Todos os dias busco está por dentro das novidades do mercado, trabalho com
                        responsabilidade e flexibilidade,</p>
                </div>
            </div>
        </div>
    </section>
